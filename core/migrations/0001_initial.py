    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('gerente', 'Gerente'), ('empleado', 'Empleado')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prestamo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.prestamo')),
            ],
        ),
    ]
